...
import Library from './Library-System.jpeg'
    ...
    <div className='h-screen bg-[#010e1b] text-white flex flex-col items-center pt-8'>
        <div className=' flex flex-col align-middle justify-center gap-10  w-2/5'>
            ...
            <div className=' gallery-cards grid grid-cols-2 gap-10'>
                ...
                <a className=' gallery-card flex flex-col gap-4 justify-start' href="https://github.com/kauxp/Library-Management-System">
                    <img  src={Library}/>
                </a>
                ...
                <a className=' gallery-card flex flex-col gap-4 justify-start' href="https://github.com/kauxp/QuizApp">
                    <img  src={quiz}/>
                </a>
